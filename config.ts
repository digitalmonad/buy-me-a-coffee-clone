...
export const AIRTABLE_SECRET_API_TOKEN = process.env
  .AIRTABLE_SECRET_API_TOKEN as string;

export const AIRTABLE_DONATIONS_TABLE_URL = process.env
  .AIRTABLE_DONATIONS_TABLE_URL as string;
